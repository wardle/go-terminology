...
const (
	primitive Identifier = 900000000000074008 // defines a primitive concept does not have sufficient defining relationships to computably distinguish them from more general concepts(supertypes.
	defined   Identifier = 900000000000073002 // defines a concept with a formal logic definition that is sufficient to distinguish its meaning from other similar concepts.
)
...
const (
	definition         Identifier = 900000000000550004 // A term representing the associated concept in the language indicated by Description .languageCode.
	fullySpecifiedName Identifier = 900000000000003001 // A term unique among active descriptions in SNOMED CT that names the meaning of a concept code in a manner that is intended to be unambiguous and stable across multiple contexts.
	synonym            Identifier = 900000000000013009 // A term that is an acceptable way to express a the meaning of a SNOMED CT concept in a particular language.
)
...
const (
	...
	definingRelationship   Identifier = 900000000000006009 // NB:  has children inferred and stated
	inferredRelationship   Identifier = 900000000000011006 // NB: IS-A defining
	statedRelationship     Identifier = 900000000000010007 // NB: IS-A defining
...
const (
	rootRefset             Identifier = 900000000000455006 // root concept for all reference set types
	refSetDescriptorRefset Identifier = 900000000000456007 // represented by RefsetDescriptorReferenceSet
	simpleRefset           Identifier = 446609009          // represented by SimpleReferenceSet
	languageRefset         Identifier = 900000000000506000 // represented by LanguageReferenceSet
	simpleMapRefset        Identifier = 900000000000496009 // represented by SimpleMapReferenceSet
	complexMapRefset       Identifier = 447250001          // represented by ComplexMapReferenceSet
	extendedMapRefset      Identifier = 609331003          // represented by ComplexMapReferenceSet
)
